...
class ConversationSession:
    ...
    def __init__(self, context_size: int = 1048576, encoding_name: str = DEFAULT_ENCODING):
        ...
        self._system_message: Optional[dict[str, object]] = None
                    ...
                    if isinstance(value, str):
                        ...
                        for part in value:
                            ...
                            # image_url parts: approximate token cost
                                ...
                                total += 85  # approximate overhead per image
                elif key == "tool_calls":
    ...
    def compress(self) -> str:
        ...
        logger.info(f"Compressed {oldest_count} messages, kept {len(kept_messages)}. "
